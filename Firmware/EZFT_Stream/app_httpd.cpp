...
#define LED_LEDC_GPIO            1  //设置LED引脚
#define LED_GPIO_NUM            1
#define CONFIG_LED_MAX_INTENSITY 255

int led_duty = 255; //设置默认亮度（0-255）
...
void enable_led(bool en) {
  if (en) {
    gpio_set_level((gpio_num_t)LED_GPIO_NUM, 1);
  } else {
...
void setupLedFlash(int pin) {
  ...
  gpio_set_level((gpio_num_t)pin, 0);  // 初始关闭
